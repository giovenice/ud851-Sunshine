...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView mErrorMsg_TextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mErrorMsg_TextView = (TextView) findViewById(R.id.tv_error_msg);
        // TODO (17) Find the ProgressBar using findViewById
        mProgressBar = (ProgressBar) findViewById(R.id.prgress_bar1);
    ...
    public void showWeatherDataView(){
        mErrorMsg_TextView.setVisibility(View.INVISIBLE);
        mWeatherTextView.setVisibility(View.VISIBLE);
    }

    // TODO (9) Create a method called showErrorMessage that will hide the weather data and show the error message

    public void showeErrorMessage(){
        mErrorMsg_TextView.setVisibility(View.VISIBLE);
